...
numb1=40; //Assignement only
console.log(`numb1 is ${numb1} its type is ${numb1}`)
let numb2=60
...
let numb5=numb1**3 //2*2*2 power -> 2*2*2
console.log(`numb5 is ${numb5} its type is ${typeof numb5}`)
let numb6=Math.pow(10,3)//2^3
...
//Calculation ->
// is a anumber x a multiple of 11
